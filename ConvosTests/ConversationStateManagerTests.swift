...
@Suite("ConversationStateManagerTests")
struct ConversationStateManagerTests {
    ...
    func testAddingMemberCreatesDraftConversation() async throws {
        ...
        let writer = stateManager
        let repository = stateManager.draftConversationRepository
...
//        #expect(secondMessages.last?.base.content == .text("GM!"))
    ...
    func testAddingMembersWithExistingConversation() async throws {
        ...
        let stateManager2 = messagingService.conversationStateManager()
        let writer2 = stateManager2
        let repository2 = stateManager2.draftConversationRepository
