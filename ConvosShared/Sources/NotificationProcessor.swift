...
public class NotificationProcessor {
    public static let shared: NotificationProcessor = NotificationProcessor()
    ...
    public func processNotificationPayload(_ userInfo: [AnyHashable: Any]) throws -> NotificationPayload {
    ...
    public func storeDecryptedMessage(
    ...
    public func getStoredMessages(for conversationId: String) -> [[String: Any]]? {
        let storageKey = "\(NotificationConstants.StorageKeys.conversationMessagesPrefix)\(conversationId)"
    ...
    public func addSubscribedTopic(_ topic: String) {
        var topics = getSubscribedTopics()
        topics.insert(topic)
        storeSubscribedTopics(topics)
    }

    public func removeSubscribedTopic(_ topic: String) {
        var topics = getSubscribedTopics()
        topics.remove(topic)
        storeSubscribedTopics(topics)
    }
    ...
    public func buildNotificationContent(from processedContent: ProcessedNotificationContent) -> UNMutableNotificationContent {
    ...
    public func getConversationIdFromTopic(_ topic: String) -> String {
